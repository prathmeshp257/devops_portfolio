      ...
      <Container>
        ...
        <Col md={6} className="project-card">
            <ProjectCards
              ...
              description="Flipkart is one of the best and trending eCommerce sites with a presence throughout India. The online shopping website is for Buying and Selling products online within the network.Prathmesh Patil's Flipkart clone is a ready-made remarkable multi-vendor eCommerce site Entrepreneurs can start their own business like Flipkart, it has RazorPay Integration and get money from anywhere, in mobile, web, and iOS platforms, Completely responsive design using Material UI."              link="https://github.com/prathmeshpatil/flipkart"
            />
          </Col>
          <Col md={6} className="project-card">
            <ProjectCards
              ...
              link="https://github.com/prathmeshpatil/olx"
            />
          </Col>
