          ...
          <Row>
           ...
           <h4 >Phone Number</h4> 
              ...
              <p>
                ...
                <AiOutlineMail/> prathmeshpatil1@gmail.com
              </p>
              </Col>
            ...
            <Col md={12} className="home-about-social">
              ...
              <ul className="home-about-social-links">
                <li className="social-icons">
                  <a
                    href="https://github.com/prathmeshpatil"
                    target="_blank"
                    rel="noreferrer"
                ...
                <li className="social-icons">
                  <a
                    href="https://www.linkedin.com/in/prathmeshpatil/"
                    target="_blank"
                    rel="noreferrer"
                    className="icon-colour  home-social-icons"
                  >
                ...
                <li className="social-icons">
                  <a
                    href="https://www.instagram.com/prathmeshpatil/"
                    target="_blank"
                    rel="noreferrer"
                    className="icon-colour home-social-icons"
                  >
